...
c.JupyterHub.cookie_secret_file = '/home/ubuntu/jupyterhub/jupyterhub_cookie_secret'
...
c.JupyterHub.db_url = 'sqlite:////home/ubuntu/jupyterhub/jupyterhub.sqlite'
...
c.JupyterHub.extra_log_file = '/home/ubuntu/jupyterhub/jupyterhub.log'
...
# c.SystemUserSpawner.host_homedir_format_string = '/home/ubuntu/jupyterhub/home/{username}'

# ------------------------------------------------------------------------------
# TesSpawner(Spawner) configuration
# ------------------------------------------------------------------------------
c.JupyterHub.spawner_class = 'tesspawner.TesSpawner'
c.TesSpawner.endpoint = "http://127.0.0.1:8000/v1/jobs"
c.Spawner.options_form = """
